...
% %Dan Knudsen 10/31/2013 - Windows does not like the LD_LIBRARY_PATH ="" bit, and I can't figure out where else it's used in this codebase. 
% %For now, I'm commenting it out; everything seems to work well without it - I have no idea what this will do in other environments

cstr = sprintf('%s --nfft %d --fftshift %d --nw %1.1f --df %3.2f --dt %3.2f --thresh %3.2f --min-size %3.2f --spec %s', ...
               params.labeller, params.nfft, params.fftshift, ...
               params.nw, params.df, params.dt, ...
               params.thresh, params.min_size, signalfile);
